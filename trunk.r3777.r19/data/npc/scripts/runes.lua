...
shopModule:addBuyableItem({'wild growth rune'}, 2269, 170, 1, 'wild growth rune')
shopModule:addBuyableItem({'firebomb rune'}, 2305, 117, 1, 'firebomb rune')
...
shopModule:addBuyableItem({'energy bomb rune'}, 2262, 85, 1, 'energy bomb rune')

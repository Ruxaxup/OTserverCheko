...
shopModule:addBuyableItem({'heavy magic missile', 'hmm'},		2311, 1000, 50,	'heavy magic missile rune')
shopModule:addBuyableItem({'great fireball', 'gfb'},			2304, 1000, 50,	'great fireball rune')
shopModule:addBuyableItem({'explo', 'xpl'},				2313, 2000, 50,	'explosion rune')
shopModule:addBuyableItem({'ultimate healing', 'uh'},			2273, 3000, 50,	'ultimate healing rune')
shopModule:addBuyableItem({'sudden death', 'sd'},			2268, 3000, 50,	'sudden death rune')

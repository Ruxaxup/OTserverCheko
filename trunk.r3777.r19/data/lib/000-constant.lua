...
CONST_ME_REDENERGY	= 70
CONST_ME_NONE = 255
CONST_ME_LAST = CONST_ME_REDENERGY
...
CONST_ANI_CAKE = 41
CONST_ANI_CRYSTAL = 42
CONST_ANI_PRISMATIC = 43
CONST_ANI_WEAPONTYPE = 254
CONST_ANI_NONE = 255
CONST_ANI_LAST = CONST_ANI_PRISMATIC
...
RETURNVALUE_YOUNEEDTOSPLITYOURSPEARS = 54
...
--Global STORAGE
STHENO_SPAWN	= 5000
DEVOVORGA_SPAWN	= 5001
DEVOVORGA_START = 5002
...
TASKS_INFO = 
{
    ...
    ["rotworm"]                     = {s = 3014, r = 2173, count = 100},
    ["mini brigand"]                = {s = 3015, r = 9971, count = 100},
    ["giant spider"]                = {s = 3016, r = 2173, count = 300},
    ["dragon lord"]                	= {s = 3017, r = 2173, count = 300}
}

--Special Raid
brigandArea = {
	fromPos = {x = 1046, y = 676, z = 7},
	toPos = {x = 1068, y = 695, z = 7}
}

--WEAPON_SWORD = 1
--WEAPON_CLUB = 2
--WEAPON_AXE = 3
WEAPONS = { WEAPON_SWORD, WEAPON_CLUB, WEAPON_AXE, WEAPON_DIST }
